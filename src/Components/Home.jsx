...
var curr =
	today_date.getFullYear() + '-' + month + '-' + (today_date.getDate() - 1);
const nasa_url =
	'https://api.nasa.gov/planetary/apod?api_key=Z1GIRvQPk9eTsR68KiZVHXf9tsnTXIPurXUeiJqV&date=';
			...
			return (
				<>
					<nav className="navbar sticky-top">
						<img
							className="logo"
							src="https://dl.dropboxusercontent.com/s/yudlkrxyr11u73t/logo.png?dl=0"
							alt="logo"
						/>
